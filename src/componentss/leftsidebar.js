 ...
 const handleSearch = async () => {
      ...
      {showDrawer && (
        <div className={`drawer ${showDrawer ? 'open' : ''}`} style={{cursor:"pointer"}}>
          ...
          <div className="navlink">
            <AccountCircleIcon sx={{fontSize:"25px", margin:"0px 10px"}}/>
          <div className="drawer-option" >Account Details</div>
            </div>
            <div className="navlink">
              <HelpIcon sx={{fontSize:"25px", margin:"0px 10px"}}/>
          <div className="drawer-option" onClick={()=>navigate("/help")}>Help</div>

              </div>
          <div className="drawer-option">
           <div className="navlink">
            <AccessTimeIcon sx={{fontSize:"25px", margin:"0px 10px"}}/>
           <strong>Daily Limit</strong>
            ...
            <div className="daily-limit-options">
              ...
              <Button onClick={()=> handleDailyLimitChange(36000000)}>60 minutes</Button>
            </div>
          </div>
        </div>
      )}
  ...
  <div className="searchBarOverlay">
    <div className="searchBar">
      <span onClick={() => setShowSearchBar(false)} style={{cursor: 'pointer', color: 'blue'}}>Close</span>
      <input
        type="text"
